...
<section id="main-content">
          <section class="wrapper">
          	<h3><i class="fa fa-angle-right"></i> Buy more Food </h3>
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" action="index.php?action=manage_add_food" method="POST">
                          ...
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Kind of food</label>
                              <div class="col-sm-2">                                  
                              <select class="form-control" title="Place" name="food_kind">                                                            
                          ...
                          <button type="submit" value="Add" class="btn btn-theme"><i class="fa fa-check">Buy</i></button>
                          <div class="col-lg-1">
                          ...
                          <div class="form-group">
                              <button class="btn btn-theme" value="cancel" /><a href="index.php?action=food" /><i class="fa fa-arrow-left">Cancel</i></button>
                          </div>
                  </div>
          		</div><!-- col-lg-12-->      	
          	</div><!-- /row -->
