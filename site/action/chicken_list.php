...
               
  <input type="hidden" name="animal_id" value="4"/>
<input type="submit" name="submit" value="add a chicken" style="float: right;">
...
                <td>
                        <form method="post" action="index.php?action=list/chicken_delete">
               
